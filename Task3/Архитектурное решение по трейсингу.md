...
graph LR
  ...
  subgraph TRACING["Tracing (NEW)"]
    OTel["OpenTelemetry Collector"]
    TraceDB[("Tracing backend<br/>Jaeger или Tempo")]
    TraceUI["Tracing UI<br/>Grafana или Jaeger UI"]
  end
  ...
  class OTel,TraceDB,TraceUI new;
  style TRACING stroke:#d00,stroke-width:2px;
```
